...
class Product():
    ...
    def __init__(self, id, name, description, quantity, created_at = None, updated_at = None, deleted_at = None):
    ...
    def from_dict(cls, dict):
        ...
        return Product(id, name, description, quantity, created_at, updated_at, deleted_at)